...
const FeaturedItem = ({ title, thumbnail }: FeaturedItemProps) => {
  return (
    <div className="w-full flex gap-3 items-center rounded-md overflow-hidden bg-foreground-lighter hover:bg-foreground-lighter-hover transition duration-300 cursor-pointer shadow-md group/featured">
      {/* THUMBNAIL */}
